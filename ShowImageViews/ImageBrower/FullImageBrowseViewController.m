//
//  FullImageBrowseViewController.m
//  ShowImageViews
//
...
@interface FullImageBrowseViewController ()<UIScrollViewDelegate,ZoomScaleDelegate>
{
    NSInteger currentNu;
}
...
@implementation FullImageBrowseViewController
